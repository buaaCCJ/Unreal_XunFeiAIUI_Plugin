...
public:
	...
	static FSpeechRecoginzer & GetInstance()
	{
		static FSpeechRecoginzer speechrecoginzer("static soeech recoginzer be created !");
		return speechrecoginzer;
	}
...
public:
	...
	int sr_init(struct speech_rec * sr, enum sr_audsrc aud_src, int devid, struct speech_rec_notifier * notifier,
